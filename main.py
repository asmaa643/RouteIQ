...
def create_A_search_problem(commands):
    ...
    start_state = ('#', [False for _ in orders], [False for _ in orders])
...
def create_planning_problem(commands):
    ...
    return PlanningProblem(domain, problem)

if __name__ == '__main__':

    ############################### A* Search ############################

    problem, routes = create_A_search_problem(sys.argv)
    ...
    prob = create_planning_problem(sys.argv)
